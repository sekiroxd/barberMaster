...
<body>
    ...
    <main>
        ...
        <div class="container">
            <input type="text" id="searchBar" class="search-bar" placeholder="Keresd meg a megfelelő szalont!">
            <div class="barbers">
                <div class="container">
                    <div class="row profile-section" id="root">
                        <!-- Barber profiles will be dynamically inserted here -->
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        const product = [
            { id: 0, image: 'assets/img/gallery/team1.png', title: 'Hairway to Heaven', link: 'Barber1.php' },
            { id: 1, image: 'assets/img/gallery/team2.png', title: 'Trim Trends', link: 'Barber2.php' },
            { id: 2, image: 'assets/img/gallery/team3.png', title: 'Hair Hub', link: 'Barber3.php' },
            { id: 3, image: 'assets/img/gallery/team4.png', title: 'Timeless Trims', link: 'Barber4.php' },
            { id: 4, image: 'assets/img/gallery/team5.png', title: 'Vajers Place', link: 'Barber5.php' },
            { id: 5, image: 'assets/img/gallery/team6.png', title: 'Bark and Bath Boutique', link: 'Barber6.php' },
        ];
            ...
            document.getElementById('root').innerHTML = items.map((item) => {
                ...
                return `
                    <div class="col-md-4 profile">
                        ...
                        <button><a href="${link}" style="text-decoration: none; color: orange">Foglalás</a></button>
                    </div>`;
            }).join('');
        };
